...
def _get_detections(generator, model, score_threshold=0.05, max_detections=100, save_path=None):
    ...
    for i in progressbar.progressbar(range(generator.size()), prefix='Running network: '):
        ...
        if save_path is not None:
            image = draw_annotations(raw_image, generator.load_annotations(i), label_to_name=generator.label_to_name)
            image = draw_detections(image, image_boxes, image_scores, image_labels, label_to_name=generator.label_to_name, score_threshold=score_threshold)
...
def evaluate(
    ...
    # Arguments
        ...
        iou_thresholds  : list of thresholds used to consider when a detection is positive or negative.
        ...
        for label in range(generator.num_classes()):
            ...
            for i in range(generator.size()):
                ...
                for d in detections:
                    ...
                    overlaps            = compute_overlap(np.expand_dims(d, axis=0), annotations) # Overlaps gives back IoU Value
    ...
    return all_average_precisions, inference_time
